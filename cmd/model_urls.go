...
var onnxModelURLs = []string{
	"https://onnxzoo.blob.core.windows.net/models/opset_9/bidaf/bidaf.tar.gz",
	...
	"https://onnxzoo.blob.core.windows.net/models/opset_10/ssd/ssd.tar.gz",
	...
	"https://onnxzoo.blob.core.windows.net/models/opset_10/yolov3/yolov3.tar.gz",
