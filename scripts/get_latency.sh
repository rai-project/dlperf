...
do
    ...
    do
      ...
      # ./dlperf benchinfo --model_path ~/data/carml/dlperf/ResNet50-v1/ --benchmark_database results/nhwc_low_prec/${machine}/${batch_size}.json --short=false --batch_size=${batch_size} --human=false --strategy=parallel --output_file=./assets/nhwc_latency_float16/batchsize_${batch_size}/${machine} --total=true --format=csv --trim_layer_name=false --datatype=float16
      # ./dlperf benchinfo --model_path ~/data/carml/dlperf/ResNet50-v1/ --benchmark_database results/nhwc_low_prec/${machine}/${batch_size}.json --short=false --batch_size=${batch_size} --human=false --strategy=serial --output_file=./assets/serial_fused_nhwc_latency_float16/batchsize_${batch_size}/${machine} --total=true --format=csv --trim_layer_name=false --datatype=float16 --fused
      # ./dlperf benchinfo --model_path ~/data/carml/dlperf/ResNet50-v1/ --benchmark_database results/nhwc_low_prec/${machine}/${batch_size}.json --short=false --batch_size=${batch_size} --human=false --strategy=parallel --output_file=./assets/fused_nhwc_latency_float16/batchsize_${batch_size}/${machine} --total=true --format=csv --trim_layer_name=false --datatype=float16 --fused
    done
done
