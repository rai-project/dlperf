...
//go:generate go-bindata -nomemcopy -prefix results/ -prefix assets/ -pkg cmd -o cmd/results_static.go -ignore=.DS_Store -ignore=profile  -ignore=README.md results/... assets/...
